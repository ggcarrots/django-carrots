...
def setup(app):
    ...
    # Add Django's custom role for x-refs
    ...
    app.add_crossref_type(
        ...
        rolename = "templatetag",
        indextemplate = "pair: %s; Django template tag",
    )

    app.add_crossref_type(
        directivename = "django-admin",
        rolename = "django-admin",
        indextemplate = "pair: %s; django-admin.py command",
    )
...
intersphinx_mapping = {
    ...
    'django': ('https://docs.djangoproject.com/en/1.6/', 'https://docs.djangoproject.com/en/1.6/_objects/')
}
